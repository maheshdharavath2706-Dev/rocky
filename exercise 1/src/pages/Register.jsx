  ...
  return (
    <div 
      ...
      style={{ 
        ...
        backgroundImage: 'linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url(https://images.unsplash.com/photo-1504674900247-0877df9cc836?auto=format&fit=crop&q=80&w=2000)',
    ...
    >
      <div className="card glass p-8" style={{ width: '100%', maxWidth: '400px', padding: '2.5rem', margin: '0 auto', border: '1px solid rgba(255,255,255,0.3)', boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.5)' }}>
        <h2 className="text-center mb-6" style={{ textAlign: 'center', marginBottom: '1.5rem', fontWeight: 800 }}>Create Account</h2>
        <form>
          <div className="form-group">
            <label className="form-label" htmlFor="name" style={{ fontWeight: 600 }}>Full Name</label>
            <input type="text" id="name" className="form-input" placeholder="John Doe" style={{ backgroundColor: 'rgba(255,255,255,0.9)' }} />
          </div>
          <div className="form-group">
          ...
          <button className="btn btn-primary w-full" style={{ width: '100%', marginBottom: '1.5rem', padding: '0.875rem' }}>Create Account</button>
        </form>
